    ...
    <View style={styles.cont}>
      <Dropdown
        ...
        onChange={value =>
          setReport({
            ...report,
            address: {...report.address, region: value.value},
          })
        }
        labelField="label"
        valueField="value"
      ...
      <TextInput
        ...
        onChangeText={value =>
          setReport({
            ...report,
            address: {...report.address, streetAddress: value},
          })
        }
      ...
      <TextInput
        ...
        onChangeText={value =>
          setReport({...report, address: {...report.address, building: value}})
        }
      ...
      <TextInput
        ...
        onChangeText={value =>
          setReport({...report, address: {...report.address, city: value}})
        }
        placeholder="City"
        placeholderTextColor={COLORS.black}
      />
      <TextInput
        ...
        onChangeText={value =>
          setReport({...report, address: {...report.address, country: value}})
        }
        placeholder="Country"
        placeholderTextColor={COLORS.black}
      />
      <TextInput
        ...
        onChangeText={value =>
          setReport({
            ...report,
            address: {...report.address, postalCode: value},
          })
        }
